							...
							<li class="submenu">
								...
								<ul>
									<li><a href="{{ route('student-list') }}"
											class="{{ request()->routeIs('student-list') ? 'active' : '' }}">Student List</a></li>
									<li><a href="{{ route('student-add') }}"
											class="{{ request()->routeIs('student-add') ? 'active' : '' }}">Student Add</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Managers</span> <span
										class="menu-arrow"></span></a>
								<ul>
									<li><a href="{{ route('manager-list') }}"
											class="{{ request()->routeIs('manager-list') ? 'active' : '' }}">Manager List</a></li>
									<li><a href="{{ route('manager-add') }}"
											class="{{ request()->routeIs('manager-add') ? 'active' : '' }}">Manager Add</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="#"><i class="fa fa-sticky-note"></i> <span>Enrollments</span> <span
										class="menu-arrow"></span></a>
								<ul>
									<li><a href="{{ route('enrollment-list') }}"
											class="{{ request()->routeIs('enrollment-list') ? 'active' : '' }}">Enrollment List</a>
									</li>
									<li><a href="{{ route('enrollment-add') }}"
											class="{{ request()->routeIs('enrollment-add') ? 'active' : '' }}">Enrollment Add</a>
									</li>
								</ul>
							</li>
							<li class="submenu">
								...
								<ul>
									<li><a href="{{ route('admin-list') }}"
											class="{{ request()->routeIs('admin-list') ? 'active' : '' }}">Admin List</a></li>
									<li><a href="{{ route('admin-add') }}"
											class="{{ request()->routeIs('admin-add') ? 'active' : '' }}">Admin Add</a></li>
								</ul>
							</li>
