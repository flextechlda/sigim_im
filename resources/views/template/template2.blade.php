...
<body>
    ...
    <div class="div-home">
        <aside>
            ...
            <ul>
                <li @yield('active-home')><a href="{{ route('home') }}"> <i class="bi bi-card-text"></i> Inscrição</a></li>
                <li @yield('active-perfil')><a href="{{ route('perfil') }}"> <i class="bi bi-person-bounding-box"></i> Personaliza&ccedil;&atilde;o</a></li>
            </ul>
        </aside>
